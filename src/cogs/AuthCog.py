...
```
```
Вы также можете  рекламу или дополнительные возможности, используя канал #Выбор-ролей\n
...
class MainAuthButtons(nextcord.ui.View):
    def __init__(self):
        ...
        self.add_item(nextcord.ui.Button(label="#Выбор-ролей", url="https://discord.com/channels/691182902633037834/1126098284952436806/"))
        self.add_item(nextcord.ui.Button(label="#Select-Roles", url="https://discord.com/channels/691182902633037834/1126098284952436806/"))
